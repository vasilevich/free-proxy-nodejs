...
exports.getProxies = exports.ProxyProtocol = void 0;
...
function getProxies(otps) {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, html, $, proxies, protocol, activeProxies;
        var _this = this;
            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    $('table > tbody table > tbody tr').each(function () {
                        ...
                        var latency = $(this).find('td:nth-child(6)').text().trim();
                    ...
                    protocol = (otps || {}).protocol;
                    if (protocol) {
                        proxies = proxies.filter(function (proxy) { return proxy.protocol === protocol; });
                    }
